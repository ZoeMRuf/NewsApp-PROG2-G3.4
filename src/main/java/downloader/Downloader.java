...
public abstract class Downloader {
    ...
    public abstract int process(List<String> urls) throws NewAPIException;

    public String saveUrl2File(String urlString) throws NewAPIException {
        InputStream is = null;
        ...
        try {
            ...
            throw new NewAPIException("Cannot convert " + urlString + " to URL. Error message: " + e.getMessage());
        } catch (IOException e) {
            throw new NewAPIException("Either failed to open URL: " + urlString + " or failed to write to Folder. Error message: " + e.getMessage());
        } finally {
            try {
                if(is != null)
                    is.close();
